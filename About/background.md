...
Uses polars for transformations and data manipulation 
and to construct pipeline of tasks/steps and run end-to-end. 
Plotly for graphing.
Python-pptx for report creation
See repo [here](https://github.com/TimothyAllman/DataScienceTemplate)
