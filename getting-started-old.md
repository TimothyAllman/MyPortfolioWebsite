...
To do so, go to <https://github.com/rikhuijzer/MyPortfolioWebsite> and click on the big "Use this template" button.
...
Otherwise, enable the GitHub Actions in the repository settings or open an issue at <https://github.com/rikhuijzer/MyPortfolioWebsite/issues/new>.
...
Next, search for `MyPortfolioWebsite` inside your repository and replace all occurrences of that word by the name of your repository.
